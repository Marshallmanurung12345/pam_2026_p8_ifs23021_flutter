...
class AuthService {
  ...
  Future<ApiResponse<String>> register({
    ...
    final uri = ApiConstants.uri(ApiConstants.authRegister);
  ...
  Future<ApiResponse<Map<String, String>>> login({
    ...
    final uri = ApiConstants.uri(ApiConstants.authLogin);
    final response = await _client.post(
      uri,
      headers: {'Content-Type': 'application/json'},
  ...
  Future<ApiResponse<Map<String, String>>> refreshToken({
    ...
    final uri = ApiConstants.uri(ApiConstants.authRefresh);
    final response = await _client.post(
      uri,
      headers: {'Content-Type': 'application/json'},
      body: jsonEncode(
  ...
  Future<ApiResponse<void>> updatePassword({
    ...
    final uri = ApiConstants.uri(ApiConstants.usersMePassword);
    final response = await _client.put(
      uri,
      headers: {
        'Content-Type': 'application/json',
